...
// NewClient Function
func NewClient(Endpoint string, LogFilter string) (*Feeder, error) {
	fd := &Feeder{}
...
func (fd *Feeder) recvMsg() (error, *pb.Message) {
...
func (fd *Feeder) recvAlerts() (error, *pb.Alert) {
...
func (fd *Feeder) recvLogs() (error, *pb.Log) {
